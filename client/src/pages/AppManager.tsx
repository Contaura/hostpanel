...
import { Plus, Play, Square, RotateCcw, Trash2, ChevronDown, ChevronUp, Terminal, Cpu, MemoryStick } from 'lucide-react';
          ...
          <div key={app.name} className="card overflow-hidden">
            <div className="flex items-center gap-4 p-4">
              ...
              <div className="flex items-center gap-1">
                ...
                <button className="btn-ghost" onClick={() => setExpanded(expanded === app.name ? null : app.name)}>
