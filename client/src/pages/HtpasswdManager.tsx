        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {dirs.length === 0 ? (
              ...
              <>
                <tr key={d.directory} className={rowCls}>
                ...
                {showAddUser === d.directory && (
                  <tr key={`${d.directory}-add`} className="bg-indigo-50/40 dark:bg-indigo-900/10 border-b border-slate-50 dark:border-slate-700/40">
