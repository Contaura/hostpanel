    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-wrap gap-3 items-end">
        ...
        <div>
          ...
          <select className="input w-52" value={selected}
        ...
        <div>
          ...
          <select className="input w-28" value={lines}
        ...
        <div className="flex-1 min-w-48">
          ...
          <div className="flex gap-2">
            <input className="input flex-1" placeholder="Filter by keyword…"
              value={search} onChange={e => setSearch(e.target.value)}
              onKeyDown={e => e.key === 'Enter' && searchLog()} />
      ...
      {currentLog && (
        <p className="text-xs font-mono text-slate-400 dark:text-slate-500">{path}</p>
      )}
      ...
      <div className="card overflow-hidden">
        {loading ? (
          ...
          <pre className="text-xs font-mono text-slate-700 dark:text-slate-300 whitespace-pre-wrap p-4 overflow-auto max-h-[70vh] leading-relaxed">
            {content}
          </pre>
        ) : (
