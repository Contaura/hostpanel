...
- Added a `backup_age` monitoring rule that raises `system.backup_stale` notifications when the newest HostPanel backup archive is older than the configured threshold.
