...
export const FEATURE_CATALOG = [
  ...
  { key: 'logs', label: 'Log Viewer', group: 'files' },
  { key: 'domains', label: 'Domains', group: 'domains' },
  { key: 'subdomains', label: 'Subdomains', group: 'domains' },
  { key: 'addon-domains', label: 'Addon Domains', group: 'domains' },
  { key: 'parked-domains', label: 'Aliases / Parked Domains', group: 'domains' },
  { key: 'redirects', label: 'Redirects', group: 'domains' },
  { key: 'error-pages', label: 'Error Pages', group: 'domains' },
  { key: 'web-extras', label: 'Web Extras', group: 'domains' },
  ...
  { key: 'dkim', label: 'DKIM Manager', group: 'email' },
  { key: 'mail-queue', label: 'Mail Queue', group: 'email' },
  { key: 'rspamd', label: 'Rspamd / Spam Controls', group: 'email' },
  { key: 'mail-routing', label: 'Mail Routing', group: 'email' },
  { key: 'mail-tools', label: 'Mail Tools', group: 'email' },
  ...
  { key: 'databases', label: 'Databases', group: 'databases' },
  ...
  { key: 'accounts', label: 'Account Manager', group: 'accounts' },
  { key: 'billing', label: 'Billing', group: 'accounts' },
  ...
  { key: 'resellers', label: 'Reseller Manager', group: 'accounts' },
  ...
  { key: 'ssh-keys', label: 'SSH Keys', group: 'security' },
  { key: 'firewall', label: 'Firewall', group: 'security' },
  { key: 'htpasswd', label: 'Directory Privacy', group: 'security' },
  { key: 'security-extra', label: 'Security Extras', group: 'security' },
  { key: 'waf', label: 'Web Application Firewall', group: 'security' },
  { key: 'ssl-advanced', label: 'Advanced SSL', group: 'security' },
  { key: 'security-scanner', label: 'Security Scanner', group: 'security' },
  { key: 'cron', label: 'Cron Jobs', group: 'server' },
  { key: 'php', label: 'PHP Manager', group: 'server' },
  { key: 'processes', label: 'Process Manager', group: 'server' },
  { key: 'ftp', label: 'FTP Manager', group: 'server' },
  { key: 'scripts', label: 'Script Installer', group: 'server' },
  { key: 'apps', label: 'Application Manager', group: 'server' },
  { key: 'alerts', label: 'Alerts', group: 'server' },
  { key: 'settings', label: 'Settings', group: 'system' },
  { key: 'admin-users', label: 'Admin Users', group: 'system' },
  { key: 'api-tokens', label: 'API Tokens', group: 'system' },
  { key: 'cloudflare', label: 'Cloudflare', group: 'integrations' },
  { key: 'git-deploy', label: 'Git Deploy', group: 'integrations' },
  { key: 'cache', label: 'Cache Manager', group: 'integrations' },
  { key: 'wordpress', label: 'WordPress Manager', group: 'apps' },
  { key: 'node-apps', label: 'Node.js Apps', group: 'apps' },
  { key: 'resource-limits', label: 'Resource Limits', group: 'server' },
  { key: 'notifications', label: 'Notifications', group: 'system' },
  { key: 'server-info', label: 'Server Info', group: 'server' },
];
